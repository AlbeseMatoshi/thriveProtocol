...
import {Pageable, Paginator} from "../components/Paginator.tsx";
...
export default function UsersPage() {
    ...
    const [limitItems] = useState(10); // Number of items per page

    const [{data: fetchedData, response}] = UserAPI.getAll(currentPage, localData ? undefined : debouncedUserName);
                ...
                <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    {!!dataToDisplay && (
                        <>
                            ...
                            <Paginator data={dataToDisplay as Pageable}
                                       totalPages={(response?.headers?.['x-total-count'] / limitItems) ?? 1}
